...
class CopiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create copy" do
    assert_difference('Copie.count') do
      post copies_url, params: { copy: { code: @copy.code, place: @copy.place, publication_id: @copy.publication_id } }, as: :json
    end
  ...
  test "should update copy" do
    patch copy_url(@copy), params: { copy: { code: @copy.code, place: @copy.place, publication_id: @copy.publication_id } }, as: :json
    assert_response 200
  end
